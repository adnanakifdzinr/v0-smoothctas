        ...
        >
          ...
          <div className="flex items-center gap-3 md:gap-4">
            <motion.button
              ...
              className="h-12 md:h-12 bg-white border-2 border-white rounded-full flex items-center justify-between px-1 gap-2 overflow-hidden cursor-pointer focus:outline-none relative"
            >
              <motion.span
