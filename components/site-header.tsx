        ...
        >
          ...
          <div className="flex items-center gap-3 md:gap-4">
            <motion.button
              ...
              className="h-10 md:h-12 bg-white border-2 border-white rounded-full flex items-center justify-between px-1 gap-20 overflow-hidden cursor-pointer focus:outline-none relative"
            >
              <motion.span
              ...
              <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-black flex items-center justify-center overflow-hidden relative flex-shrink-0">
                <motion.div
                  animate={{
